class WishlistItemsController < ApplicationController
  ...
  def destroy
    wishlist_item = current_user.wishlist_items.find_by(id: params[:id]) # Use ID instead of product_id

    if wishlist_item
      wishlist_item.destroy
      redirect_to user_path, notice: "Removed from wishlist."
    else
      redirect_to user_path, alert: "Item not found in wishlist."
    end
  end
